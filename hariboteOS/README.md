...
- 
### Chapter23章(グラフィックいろいろ)
- 点が書けるようになったらなんでも書けるよね
### Chapter24章(ウィンドウ操作)
- xボタンを押すことで閉じるようになった
### Chapter25章(コンソールを増やそう)
- 
### Chapter26章(ウィンドウ移動の高速化)
- 
### Chapter27章(LDTとライブラリ)
- OSを壊せないなら動作中のアプリを壊そう、、制限が弱いので攻めやすい
- プログラムを細かい部品(関数)に分けて開発して、それを組み合わせてプログラムする手法。「構造化プログラミング」
- 構造化プログラミングの考え方で、将来他のプログラムにも使えそうな部品を集めてまとめたものをライブラリ。
### Chapter28章(ファイルと日本語表示)
- 日本語はひらがな、カタカナ、漢字、同じ言葉でも様々な変換があり、よく使われるものを素早く変換したいから独自の文字コードになっている
### Chapter29章(圧縮と簡単なアプリケーション)
- 圧縮効率が良くても、復元したときに元のファイルサイズより大きくなってしまったら意味ない
- インベーダーゲームを作成
- フォントもアイコンもすべて0と1なんだなと改めて実感
### Chapter30章(高度なアプリケーション)
- 計算機、テキストビューア
- MML(music macro language)プレイヤー
- 画像ビューア
### Chapter00章()
